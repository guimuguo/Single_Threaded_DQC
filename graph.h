...
extern double gdmin_deg_ratio_o;
extern double gdmin_deg_ratio_i;
extern int gnmin_size;
extern int gnmax_size;
extern int gnmin_deg_o;
extern int *gpmin_degs_o;
extern int gnmin_deg_i;
extern int *gpmin_degs_i;
